      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden">
        ...
        <div className="relative p-16 flex flex-col justify-between">
          <Link
            ...
            className="label-tech text-brand-orange"
          >
            ← Diamond Chem India
          </Link>

          <div>
            <div className="label-tech text-brand-orange mb-3">
              Internal Access
            </div>
            ...
            <p className="mt-6 text-white/60 max-w-md">
              Manage incoming dealer orders, dispatch status and inventory
              pipeline from a single dashboard.
            </p>
          </div>

          <div className="label-tech text-white/40">
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-white text-brand-jet">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            <Link to="/" className="label-tech text-brand-orange">
              ← Back
            </Link>
          </div>
          ...
          <p className="text-muted-foreground mt-2 text-sm">
            Sign in to manage dealer orders.
          </p>
