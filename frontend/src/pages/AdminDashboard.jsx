        ...
        <div className="mb-8">
          ...
          <div className="flex gap-3 mt-6">
            <button
              ...
              className={`px-5 py-2 rounded-sm font-semibold transition ${activeTab === "orders"
                ? "bg-brand-jet text-white"
            ...
            <button
              ...
              className={`px-5 py-2 rounded-sm font-semibold transition ${activeTab === "products"
          ...
          <>
            <div className="flex items-center justify-between mb-6">
              ...
              <Link
                ...
                className="bg-brand-orange text-white px-4 py-2 rounded-sm font-semibold hover:opacity-90"
              >
                + Add Product
              </Link>
            </div>
                    ...
                    <div className="mt-4 flex justify-between items-center">
                      ...
                      <div className="flex gap-2">
                        <Link
                          ...
                          className="border border-border px-3 py-2 rounded-sm hover:bg-secondary"
                        >
                          Edit
                        </Link>
                        ...
                        <button
                          ...
                          className="bg-red-600 text-white px-3 py-2 rounded-sm hover:bg-red-700"
                        >
                          Delete
                        </button>
                      </div>
